...
class AdminController extends BaseController {
  ...
  public function addproduct() {
    ...
    if ($file['name'] != '') {
      ...
      if ($result) {
        MyUtil::showAlertAndRedirect('SUCCESSFUL', '?controller=admin&action=listproduct');
      }
     
    }
    MyUtil::showAlertAndRedirect('FAILURE', '?controller=admin&action=listproduct');
  }
  public function updateproduct() {
    ...
    if ($result) {
      MyUtil::showAlertAndRedirect('UPDATE SUCCESSFUL', '?controller=admin&action=listproduct');
    } else {
      MyUtil::showAlertAndRedirect('UPDATE FAILURE', '?controller=admin&action=listproduct');
    }
  }
  public function deleteproduct() {
    ...
    if ($result) {
      MyUtil::showAlertAndRedirect('DELETE SUCCESSFUL', '?controller=admin&action=listproduct');
    } else {
      MyUtil::showAlertAndRedirect('DELETE FAILURE', '?controller=admin&action=listproduct');
    }
  }
  public function addcategory() {
    ...
    if ($result) {
      MyUtil::showAlertAndRedirect('ADD SUCCESSFUL CATEGORY', '?controller=admin&action=listcategory');
    } else {
      MyUtil::showAlertAndRedirect('ADD FAILURE CATEGORIES', '?controller=admin&action=listcategory');
    }
  }
  public function updatecategory() {
    ...
    if ($result) {
      MyUtil::showAlertAndRedirect('UPDATE CATEGORY SUCCESSFUL', '?controller=admin&action=listcategory');
    } else {
      MyUtil::showAlertAndRedirect('UPDATE CATEGORY FAILURES', '?controller=admin&action=listcategory');
    }
  }
  ...
  public function deactive() {
    ...
    if ($result) {
      MyUtil::showAlertAndRedirect('SUCCESSFUL', '?controller=admin&action=listcustomer');
    } else {
      MyUtil::showAlertAndRedirect('FAILURE', '?controller=admin&action=listcustomer');
    }
  }
  ...
  public function deletecategory() {
    ...
    if ($result) {
      MyUtil::showAlertAndRedirect('DELETE SUCCESSFUL', '?controller=admin&action=listcategory');
    } else {
      MyUtil::showAlertAndRedirect('DELETE FAILURE', '?controller=admin&action=listcategory');
    }
  }
}
?>